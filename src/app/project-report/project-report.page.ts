...
export class ProjectReportPage implements OnInit, AfterViewInit {
  ...
  @ViewChild('popoverforCategory') popoverforCategory: any;
  @ViewChild('popoverforTask') popoverforTask: any;
  @ViewChild('popover') popover: any;
  isOpen = false;
  isOpenforTask = false;
  isOpenforcategory = false;
  programList:any;
  ...
  presentPopoverforTask(e: Event) {
    this.isOpenforTask = true;
  }

  presentPopoverforCategory(e: Event) {
    this.isOpenforcategory = true;
  }
  ...
  renderChart(taskData: any, categoryData: any): void {
    // Remove 'total' key from taskData
    const { total: taskTotal, ...filteredTaskData } = taskData;

    // Remove 'total' key from categoryData
  ...
  getprogram(event: any) {
    console.log('Selected program:', event.detail.value);
